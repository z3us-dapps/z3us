...
export interface IProps {
	...
	onAddNft: (sendIndex: number) => void
	onUpdateNft: (sendIndex: number) => (tokenIndex: number) => (address: string, symbol: string, name: string) => void
	onUpdateNftValue: (sendIndex: number) => (tokenIndex: number) => (tokenValue: number) => void
