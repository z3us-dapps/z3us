...
import { ArrowLeftIcon, LockIcon, ChevronDown2Icon  } from 'ui/src/components/icons'
				...
				<Box display="flex" flexDirection="column" gap="small">
					...
					<Box className={styles.messageWrapper}>
						<Text size="xsmall">
							...
							elit luctus lectus facilisis pellentesque augue iaculis. Malesuada vel suscipit cras convallis eget, elit
							auctor aliquet
						</Text>
					</Box>
				</Box>
