...
export const AccountsMobileIndexListItem: React.FC<IAccountsMobileIndexListItemProps> = props => {
	const { setItems } = useContext(Context)
	const { id, index, loaded, name, isImageSquare, count = 0, assetType } = props
