...
export const AccountsMobileActivityListItem: React.FC<IAccountsMobileActivityListItemProps> = props => {
	const { setItems } = useContext(Context)
	const { id, index, loaded, name } = props
	...
	return (
		<Box className={styles.mobileAccountsActivityItem}>
