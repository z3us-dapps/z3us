...
export const AccountTransfer = forwardRef<HTMLElement, IAccountTransferProps>(
	(props, ref: React.Ref<HTMLElement | null>) => {
		...
		const handleGroupTransaction = () => {
			setState(draft => {
				draft.isGroupUiVisivle = !state.isGroupUiVisivle
			})
		}
							...
							{page === 0 && (
								<Box position="relative">
									...
									<Box style={{ border: '0px solid red' }}>
										...
										<ShowHidePanel isChildrenVisible={!state.isGroupUiVisivle}>
											<Box>
															...
															<DropdownMenuRadioItem value={id} key={index}>
																<Box display="flex" alignItems="center" gap="medium">
																	...
																	<Box flexGrow={1} minWidth={0}>
																		<Text truncate>
																			{title}
																			Quisque felis sapien, sed purus sed tristique eros felis ante porttitor et, semper
																			metus nisl ut pellentesque euismod. Purus bibendum posuere donec eget, ac
																			imperdiet rhoncus nunc nisi
																		</Text>
																	</Box>
																</Box>
																<DropdownMenuItemIndicator>
												...
												<Box display="none" flexDirection="column" gap="small">
