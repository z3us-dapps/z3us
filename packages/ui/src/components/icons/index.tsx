...
export { default as TouchIcon } from './touch-icon'
...
export { default as TextUppercaseIcon } from './text-uppercase-icon'
...
export { default as SmartPhoneIcon } from './smart-phone-icon'
export { default as QrCodeIcon } from './qr-code-icon'
export { default as QrCode2Icon } from './qr-code-2-icon'
export { default as DotsHorizontalCircleIcon } from './dots-horizontal-circle-icon'
...
export { default as RadixIcon } from './radix-icon'
