...
export const buttonClasses = {
	...
	variant: {
		...
		primary:
			'font-medium bg-violet-700 hover:bg-violet-600 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-200 text-white shadow-md rounded-full',
		secondary:
