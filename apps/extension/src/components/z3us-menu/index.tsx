...
import { Z3usIcon, TrashIcon } from 'ui/src/components/icons'
...
export const Z3usMenu: React.FC = () => {
	const { keystores, keystoreName, selectKeystore, addKeystore, removeKeystore, removeWallet, lock, seed, hw } =
	...
	const handleEditWalletName = (keyStoreName: string) => {
		setState(draft => {
			draft.editing = keyStoreName
			draft.tempEdit = keyStoreName
		})
	}
					...
					<DropdownMenuContent side="bottom" sideOffset={6} alignOffset={-3} css={{ minWidth: '130px' }}>
												...
												<Flex align="center" css={{ width: '100%', pl: '$2' }}>
													...
													<Box>
														<ToolTip message="Delete">
															<Button size="1" iconOnly color="ghost" onClick={() => handleRemoveWallet(keystoreId)}>
																<TrashIcon />
															</Button>
														</ToolTip>
														<ToolTip message="Edit">
															<Button size="1" iconOnly color="ghost" onClick={() => handleEditWalletName(keystoreId)}>
																<Pencil2Icon />
															</Button>
														</ToolTip>
													</Box>
						...
						{seed || hw ? (
							...
							<DropdownMenuItem onSelect={handleAdd}>
								<Box css={{ flex: '1', pr: '$4' }}>Add Wallet</Box>
							</DropdownMenuItem>
						)}
					</DropdownMenuContent>
				</DropdownMenu>
